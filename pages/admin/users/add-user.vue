        ...
        <div class="grid grid-cols-12 gap-5">
            ...
            <div id="content" class="col-span-12 bg-black p-4 lg:border-l white h-full md:col-span-5 md:border-l">
                ...
                <form class="mt-8 md:mt-8 md:pr-20% text-white" @submit.prevent="submitForm">
                    ...
                    <div class="mb-8">
                        <input type="email" id="email" name="email" class="form-input mt-1 block w-10/12 border-black-300 border-b white" placeholder="Email" v-model="email" required>
                    </div>
                    ...
                    <div class="mb-8 grid grid-cols-12 items-center relative">
                        <input type="date" id="birthDate" name="birthDate" class="form-input col-span-9 block border-black-300 border-b white" placeholder="Date of birth" v-model="birthDate" required>
